  ...
  (req, res, next) => {
    ...
    User.findOne({ email })
      .then((foundUser) => {
        ...
        }); //UPDATE MODEL ---ternari if file exists
      })
      .then((createdUser) => {
    ...
    .then((foundUser) => {
      ...
      if (passwordCorrect) {
        ...
        const {
          ...
          birthdate,
          profileImage,
        } = foundUser; //REVIEW THIS, do we need to deconstruct all user properties?
...
console.log("------------------------ Im here in GET verify")
